...
pr: "https://github.com/elpic/archon/pull/2"
---
...
This is the conversion mechanism that turns archon from a per-project
tool into a *company* tool: a staff engineer writes standards once in the
org repo, every new service inherits on day one. The flywheel is "more
orgs use it → more standards ecosystems → more adoption".
...
Full rationale: `.brain/features/proposed/001-adopt-in-10-seconds.md`
